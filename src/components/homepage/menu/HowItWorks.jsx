...
const HowItWorks = () => (
  <div>
    ...
    <p>4. Approve order</p>
    <p>5. Deliver rental to renter’s address (or item picked up by renter)</p>
    <p>6. Pick up rental from renter’s address (or item returned by renter), and confirm return</p>

    <p>Enso Street provides customer service to both renters and owners😊 Feel free to send us an email if you have any questions: info@ensostreet.com</p>
  </div>
);
