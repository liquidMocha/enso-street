...
export const createPaymentIntent = async (items, needsDelivery, deliveryAddress, rentDate, returnDate) => (await axios.post(`${BASE_URL}${transactionBasePath}/pay`, {
  ...
  rentDate,
  returnDate,
}, { withCredentials: true })).data.clientSecret;
